...
[![NPM Package](https://img.shields.io/npm/v/ethereumjs-util.svg?style=flat-square)](https://www.npmjs.org/package/simplechainjs-util)
...
- `Curve25519` ([curve25519-js](https://github.com/wavesplatform/curve25519-js))
